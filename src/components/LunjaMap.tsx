              ...
              <div className="relative w-full">
                ...
                {visible.map((p) => {
                  ...
                  return (
                    ...
                    >
                      <span
                        className={`relative grid place-items-center size-2.5 rounded-full font-display text-[6px] leading-none shadow-md transition-transform group-hover:scale-125 sm:size-5 sm:text-[10px] ${
                          light ? "ring-1 ring-white" : "ring-1 ring-ink"
