...
export const POIS: Poi[] = [
  ...
  { id: "beach", n: 14, name: "Accès Plage", kind: "access", x: 91.5, y: 73.5, blurb: "Chemin direct vers le sable", detail: "Une passerelle courte, droit vers l'Atlantique. Les cours de surf s'y retrouvent au lever du jour." },
