...
export const POIS: Poi[] = [
  ...
  { id: "riad", n: 7, name: "chill-out & bar", kind: "hub", x: 11.8, y: 44.3, blurb: "Lounge chill-out & bar", detail: "Lounge chill-out et bar au bord des jardins ouest, pour les après-midis au ralenti et les verres qui s'étirent." },
