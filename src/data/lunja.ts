...
export const POIS: Poi[] = [
  ...
  { id: "piscine-ayoub", n: 13, name: "Piscine & Snack Ayoub", kind: "water", x: 91.5, y: 73.5, blurb: "Piscine est + snack", detail: "La piscine est, la plus proche du chemin de la plage, avec le snack Ayoub à côté." },
